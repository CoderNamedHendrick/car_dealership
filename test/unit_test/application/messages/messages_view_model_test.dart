        ...
        () => listener(
            ...
            any(
                that: isA<MessageHomeUiState>()
                    .having((p0) => p0.uiState, 'current state should be loading', UiState.loading))),
        () => listener(
            any(that: isA<MessageHomeUiState>()),
            any(
                that: isA<MessageHomeUiState>()
                    .having((p0) => p0.uiState, 'current state should be success', UiState.success)
    ...
    testWidgets('fetch chats failure test', (tester) async {
      ...
      verifyInOrder([
        ...
        () => listener(
            ...
            any(
                that: isA<MessageHomeUiState>()
                    .having((p0) => p0.uiState, 'current state should be error', UiState.error)
