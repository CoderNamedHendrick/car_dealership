...
void main() {
  ...
  group('Explore view model test suite', () {
    ...
    test('fetch brands success test', () async {
      ...
      verifyInOrder([
        () => listener(
            null, currState.copyWith(brandsUiState: currState.brandsUiState.copyWith(uiState: UiState.idle))),
        () => listener(
            any(that: isA<ExploreHomeUiState>()),
            any(
                that: isA<ExploreHomeUiState>()
                    .having((p0) => p0.brandsUiState.uiState, 'brands ui state is loading', UiState.loading))),
        () => listener(
            any(that: isA<ExploreHomeUiState>()),
            any(
                that: isA<ExploreHomeUiState>()
                    .having((p0) => p0.brandsUiState.uiState, 'brands ui state is success', UiState.success)
    ...
    test('fetch brands failure test', () async {
      ...
      verifyInOrder([
        ...
        () => listener(
            ...
            any(
                that: isA<ExploreHomeUiState>()
                    .having((p0) => p0.brandsUiState.uiState, 'brands ui state is error', UiState.error)
    ...
    test('fetch sellers success test', () async {
      ...
      verifyInOrder([
        () => listener(
            null, currState.copyWith(sellersUiState: currState.sellersUiState.copyWith(uiState: UiState.idle))),
        () => listener(
            any(that: isA<ExploreHomeUiState>()),
            any(
                that: isA<ExploreHomeUiState>()
                    .having((p0) => p0.sellersUiState.uiState, 'sellers ui state is loading', UiState.loading))),
        () => listener(
            any(that: isA<ExploreHomeUiState>()),
            any(
                that: isA<ExploreHomeUiState>()
                    .having((p0) => p0.sellersUiState.uiState, 'sellers ui state is success', UiState.success)
    ...
    test('fetch sellers failure test', () async {
      ...
      verifyInOrder([
        ...
        () => listener(
            ...
            any(
                that: isA<ExploreHomeUiState>()
                    .having((p0) => p0.sellersUiState.uiState, 'sellers ui state is error', UiState.error)
    ...
    test('fetch locations success test', () async {
      ...
      verifyInOrder([
        () => listener(null,
            currState.copyWith(locationUiState: currState.locationUiState.copyWith(uiState: UiState.idle))),
        () => listener(
            any(that: isA<ExploreHomeUiState>()),
            any(
                that: isA<ExploreHomeUiState>().having(
                    (p0) => p0.locationUiState.uiState, 'locations ui state is loading', UiState.loading))),
        () => listener(
            any(that: isA<ExploreHomeUiState>()),
            any(
                that: isA<ExploreHomeUiState>()
                    .having((p0) => p0.locationUiState.uiState, 'locations ui state is success', UiState.success)
                    .having(
    ...
    test('fetch locations failure test', () async {
      ...
      verifyInOrder([
        ...
        () => listener(
            ...
            any(
                that: isA<ExploreHomeUiState>()
                    .having((p0) => p0.locationUiState.uiState, 'locations ui state is error', UiState.error)
    ...
    test('fetch colors success test', () async {
      ...
      verifyInOrder([
        () => listener(
            null, currState.copyWith(colorsUiState: currState.colorsUiState.copyWith(uiState: UiState.idle))),
        () => listener(
            any(that: isA<ExploreHomeUiState>()),
            any(
                that: isA<ExploreHomeUiState>()
                    .having((p0) => p0.colorsUiState.uiState, 'colors ui state is loading', UiState.loading))),
        () => listener(
            any(that: isA<ExploreHomeUiState>()),
            any(
                that: isA<ExploreHomeUiState>()
                    .having((p0) => p0.colorsUiState.uiState, 'colors ui state is success', UiState.success)
    ...
    test('fetch colors failure test', () async {
      ...
      verifyInOrder([
        ...
        () => listener(
            ...
            any(
                that: isA<ExploreHomeUiState>()
                    .having((p0) => p0.colorsUiState.uiState, 'color ui state is error', UiState.error)
    ...
    test('fetch listings success test', () async {
      ...
      verifyInOrder([
        () => listener(
            null, currState.copyWith(listingUiState: currState.listingUiState.copyWith(uiState: UiState.idle))),
        () => listener(
            any(that: isA<ExploreHomeUiState>()),
            any(
                that: isA<ExploreHomeUiState>().having(
                    (p0) => p0.listingUiState.uiState, 'listings ui state is loading', UiState.loading))),
        () => listener(
            any(that: isA<ExploreHomeUiState>()),
            any(
                that: isA<ExploreHomeUiState>()
                    .having((p0) => p0.listingUiState.uiState, 'listings ui state is success', UiState.success)
    ...
    testWidgets('fetch listings failure test', (tester) async {
      ...
      verifyInOrder([
        ...
        () => listener(
            ...
            any(
                that: isA<ExploreHomeUiState>()
                    .having((p0) => p0.listingUiState.uiState, 'listings ui state is error', UiState.error)
