...
class _ListingPageState extends ConsumerState<ListingPage> with MIntl {
  ...
  void initState() {
    ...
    WidgetsFlutterBinding.ensureInitialized().addPostFrameCallback((_) {
      ...
      final sellers = ref
          ...
          .sellers;
      ref.read(filterStateNotifierProvider.notifier).initialiseFilter(dto,
            ...
            child: SearchBar(
              ...
              onChanged: (value) {
                EasyDebounce.debounce(
                  ...
                  final filter =
                      ref.read(filterStateNotifierProvider).filter.toDto();
                  ref
              ...
              child: Wrap(
                ...
                children: [
                  ...
                  ListingFilterChip(
                    ...
                    onSelected: (selected) async {
                      if (!selected) {
                        final result = await showRangeFilteringOptions(
                          context,
                          title: 'Price',
                          min: 1000.0,
                          max: 100000.0,
                          range: RangeValues(filter.minPrice ?? 1000,
...
class ListingWidget extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    if (listingUiState.uiState == UiState.loading ||
        adminActionUiState.uiState == UiState.loading) {
